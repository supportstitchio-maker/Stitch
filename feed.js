        ...
        function renderFeed() {
          ...
          if (screenEl) screenEl.scrollTop = prevScrollTop;
        }
            ...
            return `
              <div class="flex flex-col items-center gap-1.5 flex-shrink-0 w-16">
                <div class="relative">
                  ...
                  <button onclick="event.stopPropagation(); openMyGlimpses()" title="Add to your glimpse" class="absolute z-10 rounded-full border-[2px] border-white flex items-center justify-center shadow" style="top:0;left:0;width:1.1rem;height:1.1rem;color:${NAVY};background:#ffffff;">${Icon('plus','w-2 h-2')}</button>
                </div>
