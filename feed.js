// ---- Feed render + pull-to-refresh ----
          ...
          if (count > 0) {
            return `
              <div class="flex flex-col items-center gap-1 flex-shrink-0" style="width:48px;">
                <button onclick="sendPostToSelectedContacts(${postId})" title="Send" class="rounded-full flex items-center justify-center flex-shrink-0 relative" style="width:36px;height:36px;background:linear-gradient(135deg,${ROYAL},${NAVY});color:#fff;">
                  ${Icon('send','w-[15px] h-[15px]')}
        ...
        function shareExternalOption(icon,label,onclick,bg,fg){
          ...
          return `
            <div class="flex flex-col items-center gap-1 flex-shrink-0" style="width:48px;">
              <button onclick="${onclick}" title="${label}" class="rounded-full flex items-center justify-center flex-shrink-0" style="width:36px;height:36px;background:${bg};color:${fg};">${Icon(icon,'w-[15px] h-[15px]')}</button>
        ...
        function shareGlimpseActionHTML(glimpseId){
          ...
          if (count > 0) {
            return `
              <div class="flex flex-col items-center gap-1 flex-shrink-0" style="width:48px;">
                <button onclick="sendGlimpseToSelectedContacts(${glimpseId})" title="Send" class="rounded-full flex items-center justify-center flex-shrink-0 relative" style="width:36px;height:36px;background:linear-gradient(135deg,${ROYAL},${NAVY});color:#fff;">
                  ${Icon('send','w-[15px] h-[15px]')}
                  <span class="absolute bg-white text-[9px] font-bold rounded-full flex items-center justify-center" style="top:-3px;right:-3px;width:15px;height:15px;color:${ROYAL};box-shadow:0 0 0 1.5px ${ROYAL};">${count}</span>
                </button>
                <div class="text-[10px] text-gray-600 font-medium text-center leading-tight">Send</div>
