            ...
            return `
              <div class="flex flex-col items-center gap-1.5 flex-shrink-0 w-20">
                <div class="relative">
                  ...
                  <button onclick="event.stopPropagation(); openMyGlimpses()" title="Add to your glimpse" class="absolute z-10 rounded-full flex items-center justify-center shadow" style="top:-2px;left:-2px;width:1.75rem;height:1.75rem;color:${ROYAL};background:#ffffff;border:1px solid ${ROYAL};">${Icon('plus','w-3.5 h-3.5')}</button>
                </div>
