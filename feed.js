        ...
        function storyBubble(s){
          if (s.mine) {
            ...
            return `
              <div class="flex flex-col items-center gap-1.5 flex-shrink-0 w-20">
                <div class="relative">
                  <button onclick="openMyGlimpses()" class="w-20 h-20 rounded-full overflow-hidden flex items-center justify-center" style="padding:${hasGlimpse ? '3.5px' : '0'};background:${hasGlimpse ? NAVY : 'transparent'};">
                  ...
                  <button onclick="event.stopPropagation(); openMyGlimpses()" title="Add to your glimpse" class="absolute z-10 rounded-full border-2 flex items-center justify-center shadow" style="top:-2px;left:-2px;width:1.75rem;height:1.75rem;color:${ROYAL};background:#ffffff;border-color:${ROYAL};">${Icon('plus','w-3.5 h-3.5')}</button>
                </div>
          ...
          return `
            <button onclick="viewStory('${s.id}')" class="flex flex-col items-center gap-1.5 flex-shrink-0 w-20">
              <div class="w-20 h-20 rounded-full p-[3.5px] ${ring}">
            ...
            <div class="flex flex-col h-full bg-white relative">
              ...
              <div class="flex-1 overflow-y-auto">
                ...
                <div class="px-6 pt-2 pb-4 flex justify-center">
                  <button onclick="composeGlimpseMedia()" class="flex items-center justify-center gap-2.5 rounded-full px-8 py-3 min-w-[200px]" style="color:${NAVY};background:rgba(10,37,64,0.08);">
        ...
        function postMediaKind(post){
          ...
          return /^\s*<video/i.test(post.mediaHtml) ? 'video' : 'picture';
        }
