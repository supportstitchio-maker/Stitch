          ...
          if (s.mine) {
            ...
            return `
              <div class="flex flex-col items-center gap-1.5 flex-shrink-0 w-20">
                <div class="relative">
                  <button onclick="openMyGlimpses()" class="w-20 h-20 rounded-full overflow-hidden flex items-center justify-center" style="padding:${hasGlimpse ? '3.5px' : '0'};background:${hasGlimpse ? `linear-gradient(135deg, ${NAVY}, ${ROYAL})` : 'transparent'};">
                  ...
                  <button onclick="event.stopPropagation(); openMyGlimpses()" title="Add to your glimpse" class="absolute z-10 rounded-full flex items-center justify-center shadow" style="top:0;left:0;width:1.5rem;height:1.5rem;box-sizing:border-box;color:${ROYAL};background:#ffffff;border:2px solid ${ROYAL};">${Icon('plus','w-3 h-3')}</button>
                </div>
