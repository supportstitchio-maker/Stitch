          ...
          if (s.mine) {
            return `
              <div class="flex flex-col items-center gap-1.5 flex-shrink-0 w-16">
                <div class="relative">
                  <button onclick="openMyGlimpses()" class="w-16 h-16 rounded-full overflow-hidden flex items-center justify-center" style="color:${NAVY};background:rgba(10,37,64,0.14);">${profileData.photo ? `<img src="${profileData.photo}" class="w-full h-full object-cover">` : silhouetteIcon(s.icon,'w-7 h-7')}</button>
