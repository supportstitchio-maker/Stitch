// ---- Feed render + pull-to-refresh ----
        ...
        function glimpseMediaLoadError(el){
          ...
          wrap.innerHTML = `
            <div class="px-8 text-center">
              <div class="text-sm mb-3 glimpse-retry-msg" style="color:#fff;opacity:0.85;">Couldn't load this glimpse -- check your connection</div>
        ...
        function glimpseMediaRetryTap(btn){
          ...
          const revert = () => {
            ...
            if (label) label.textContent = "Couldn't load this glimpse -- check your connection";
          };
          if (isVideo) {
