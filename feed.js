// ---- Feed render + pull-to-refresh ----
        ...
        function shareExternalOption(icon,label,onclick,bg,fg){
          ...
          fg = fg || NAVY;
          return `
            <div class="flex flex-col items-center gap-2 flex-shrink-0" style="width:64px;">
              <button onclick="${onclick}" title="${label}" class="rounded-full flex items-center justify-center flex-shrink-0" style="width:56px;height:56px;background:${bg};color:${fg};">${Icon(icon,'w-[22px] h-[22px]')}</button>
