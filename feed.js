        ...
        // true once you've opened your own Glimpse viewer since your
        // last post, so the ring goes gray just like anyone else's
        // does once seen. Resets to false (ring back to gradient) the
        // moment a new glimpse of yours is added.
        ...
        function openMyGlimpses(markViewed){
          purgeExpiredGlimpses();
          if (markViewed !== false) { myGlimpsesViewed = true; refreshStoryStrip(); }
          const ov = document.getElementById('overlay');
          ov.classList.remove('hidden');
          ov.style.top = '0';
          ov.style.paddingTop = '';
