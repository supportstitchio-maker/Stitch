        ...
        function shareExternalOption(icon,label,onclick,bg,fg){
          ...
          return `
            <div class="flex flex-col items-center gap-1.5 flex-shrink-0" style="width:56px;">
              <button onclick="${onclick}" title="${label}" class="rounded-full flex items-center justify-center flex-shrink-0" style="width:44px;height:44px;background:${bg};color:${fg};">${Icon(icon,'w-[18px] h-[18px]')}</button>
