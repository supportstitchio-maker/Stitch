          ...
          return `
            ...
            <div class="p-5 flex-1 overflow-y-auto no-scrollbar">
              ...
              <div class="relative mb-2">
                ...
                <div id="compose-mention-suggestions" class="hidden absolute left-2 right-2 bg-white rounded-2xl border border-gray-100 py-1 z-20" style="top:100%;margin-top:4px;max-height:180px;overflow-y-auto;box-shadow:0 10px 30px rgba(0,0,0,.14);"></div>
              </div>
              ...
              <div id="compose-tag-picker" class="${composeTagPickerOpen ? '' : 'hidden'} mb-3 bg-gray-50 rounded-2xl p-3">
                <input id="compose-tag-search" value="${escapeHtml(composeTagSearchQuery)}" oninput="onComposeTagSearchInput(this.value)" placeholder="Search people to tag" class="w-full border border-gray-200 rounded-xl px-3 py-2 text-sm mb-2" autocomplete="off">
