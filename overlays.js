        ...
        function menuOverlayHeader(title, menuOpen, toggleFnName, dropdownHtml, opts){
          ...
          const titleClass = opts.titleLeft
            ? 'text-base font-bold font-display grad-text truncate'
            : 'text-base font-bold font-display grad-text absolute left-1/2 -translate-x-1/2 truncate';
          return `
            <div class="w-full px-5 pb-3 relative" style="padding-top:20px;">
              <div class="flex items-center justify-between">
                ${backBtn}
                <h1 class="${titleClass}" style="max-width:60%;">${title}</h1>
        ...
        function renderClassAnnouncementsTab(){
          ...
          ov.innerHTML = `
            <div class="overflow-y-auto no-scrollbar flex-1 bg-gray-50">
              ${menuOverlayHeader('Notice Board', noticeBoardMenuOpen, 'toggleNoticeBoardMenu', notifActionsDropdownHTML('handleNoticeAction'), { hideBack: true, boldMenuIcon: true, titleLeft: true })}
              <div class="p-5">
                <div class="flex items-center justify-between pb-4 mb-4 border-b border-gray-200">
                  ${noticeSelected.size ? `
