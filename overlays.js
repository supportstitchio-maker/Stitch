        ...
        function renderClassAnnouncementsTab(){
          ...
          ov.innerHTML = `
            <div class="overflow-y-auto no-scrollbar flex-1 bg-gray-50">
              ${menuOverlayHeader('Notice Board', noticeBoardMenuOpen, 'toggleNoticeBoardMenu', notifActionsDropdownHTML('handleNoticeAction'), { hideBack: true, boldMenuIcon: true, titleLeft: true, titleSize: 'text-xl' })}
              <div class="p-5">
                <div class="flex items-center justify-between pb-4 mb-4 border-b border-gray-200">
                  ${noticeSelected.size ? `
