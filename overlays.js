        ...
        // is still in flight -- a handful of shaped placeholder rows
        // (avatar + two lines + action pill, matching personCard() below)
        // instead of a plain "Loading..." line, so the panel looks like
        // it's about to fill in rather than momentarily broken.
        function discoverSkeletonHTML(){
          const row = `
            <div class="skel-person">
              <div class="skel-person-avatar skel-avatar skel-shimmer"></div>
              <div class="skel-person-lines">
                <div class="skel-line skel-shimmer" style="width:55%;"></div>
                <div class="skel-line skel-shimmer" style="width:80%;"></div>
              </div>
              <div class="skel-person-action skel-block skel-shimmer"></div>
            </div>`;
          return row.repeat(5);
        }
        ...
        function personProfileHTML(){
          ...
          const networkCount = p.networkLoaded ? (p.network || []).length : '\u00b7\u00b7\u00b7';
          return `
