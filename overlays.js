          ...
          return `
            ...
            <div class="flex-1 overflow-y-auto p-5">
              <div class="flex flex-col items-center text-center mb-4">
                <button ${p.photo ? `onclick="viewProfilePhoto('${p.photo}')"` : ''} class="w-24 h-24 ${p.avatarBg || 'bg-blue-50'} rounded-full flex items-center justify-center text-gray-600 mb-3 overflow-hidden">${avatarInner}</button>
