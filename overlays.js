        ...
        window.addEventListener('popstate', function(){
          ...
          if (ov && !ov.classList.contains('hidden')) {
            // Same "don't hang up" behavior as the in-call back button
            // (see minimizeCall in chat.js) -- the hardware/browser back
            // gesture shouldn't end a live call either.
            if (currentOverlayKind === 'call') { minimizeCall(true); return; }
            closeOverlay(true);
          }
        });
