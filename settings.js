let appPrefs = {
          ...
          // acceptRequest in chat.js) before two users can message/connect. This is no longer user-
        ...
        // ---- Theme toggle ---- Keeps the browser/PWA chrome (status bar tint on Android/Chrome,
        // and the color-scheme hint used for native form controls/scrollbars) in sync with the
