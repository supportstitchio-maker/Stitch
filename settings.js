        ...
        // accountPrivacy defaults to 'Private' so a brand-new account
        // requires a manual Accept/Decline on every incoming connection
        // request. 'Public' auto-accepts everything the moment it arrives
        // (see autoAcceptConnectionsIfPublic) -- that should be an
        // explicit opt-in from Settings, not the out-of-the-box behavior.
        let appPrefs = {
          theme: 'light',
