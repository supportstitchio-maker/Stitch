        // ---------------- APP PREFERENCES (theme / privacy) ---------------- accountPrivacy defaults to 'Private' so a brand-new account requires a manual...
        let appPrefs = {
          theme: 'light',
        ...
        function setAccountPrivacy(v){
          ...
          openOverlay('profileMenu');
          // Public accounts don't gate who joins your network; any pending connect requests go through immediately.
        ...
        function autoAcceptConnectionsIfPublic(){
          ...
          // Snapshot the ids first -- acceptRequest() splices requestConvos as it goes, so iterating the live array directly would skip entries.
        ...
        // ---------------- Notification Settings screen (opened from the "Notifications" row under Settings and activity) ----------------
        ...
        // ---------------- Terms of Service (in-app) ---------------- Full Terms of Service text, mirrored (in short form) by the pre-login auth-terms-modal...
        ...
        // ---------------- Help Center (in-app) ---------------- FAQ content grouped by topic, mirroring the app's actual feature set (StudyBot, Feed/Stories,...
        const helpFAQData = [
