        ...
        function incomingCallHTML(){
          ...
          return `
            <div class="flex-1 flex flex-col text-white" style="background-image:url('${CALL_SCREEN_BG_IMAGE}');background-size:cover;background-position:center;text-shadow:0 1px 6px rgba(0,0,0,0.45);">
              ...
              <div class="flex flex-col items-center px-6 text-center">
                ...
                <div class="text-base text-white/90">is calling${info.groupName ? ` in "${escapeHtml(info.groupName)}"` : ''}\u2026</div>
              </div>
              <div style="flex:1;"></div>
              <div class="flex items-center justify-center" style="gap:64px;">
                <button onclick="remindMeIncomingCall()" class="flex flex-col items-center gap-2">
                  <div class="rounded-full flex items-center justify-center" style="width:44px;height:44px;background:rgba(255,255,255,0.18);">${Icon('clock','w-5 h-5')}</div>
                  <div class="text-xs">Remind Me</div>
                </button>
                <button onclick="messageIncomingCall()" class="flex flex-col items-center gap-2">
                  <div class="rounded-full flex items-center justify-center" style="width:44px;height:44px;background:rgba(255,255,255,0.18);">${Icon('comment','w-5 h-5')}</div>
              ...
              <div class="flex-shrink-0 flex items-center justify-center" style="gap:64px;padding-bottom:calc(env(safe-area-inset-bottom, 0px) + 32px);">
                <button onclick="declineIncomingCall()" title="Decline" class="flex flex-col items-center gap-2">
                  <div class="rounded-full flex items-center justify-center shadow-lg" style="width:56px;height:56px;background:#ef4444;">${Icon('phoneHangup','w-6 h-6')}</div>
                  <div class="text-xs">Decline</div>
                </button>
                <button onclick="acceptIncomingCall()" title="Accept" class="flex flex-col items-center gap-2">
                  <div class="rounded-full flex items-center justify-center shadow-lg" style="width:56px;height:56px;background:#10b981;">${Icon(isVideo ? 'video' : 'phoneOutline','w-6 h-6')}</div>
