        ...
        function incomingCallHTML(){
          ...
          return `
            <div class="flex-1 flex flex-col bg-white text-gray-900">
              <div class="flex-shrink-0 relative flex items-center justify-center px-4" style="padding-top:calc(env(safe-area-inset-top, 12px) + 40px);padding-bottom:12px;">
                <button onclick="declineIncomingCall()" title="Back" class="absolute flex items-center justify-center" style="left:16px;top:calc(env(safe-area-inset-top, 12px) + 40px);width:32px;height:32px;">${IconBold('back','w-5 h-5 text-gray-800')}</button>
                <div class="text-sm font-semibold text-gray-500 tracking-wide uppercase">Incoming ${isVideo ? 'Video' : 'Voice'} Call</div>
              </div>
