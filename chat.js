          ...
          return `
            <div class="flex items-start gap-4 px-5 py-4 bg-white">
              ...
              <div class="flex-1 min-w-0">
                ...
                ${preview
                  ? `<div class="text-xs text-gray-500 mt-0.5">${preview}</div>`
                  : `<div class="text-xs text-gray-400 italic mt-0.5">Request sent</div>`}
                <div class="flex gap-2 mt-2.5">
                  <span class="px-4 py-1.5 rounded-full text-xs font-semibold bg-amber-50 text-amber-600">Pending</span>
                  <button onclick="cancelSentRequest('${id}')" class="px-4 py-1.5 rounded-full text-xs font-semibold bg-gray-100 text-gray-600">Cancel</button>
                </div>
              </div>
              <div class="text-[11px] text-gray-400 flex-shrink-0">${time}</div>
            </div>`;
