        ...
        function convoRow(c){
          ...
          return `
            <div class="flex items-center gap-4 px-5 py-4 cursor-pointer ${isSel ? '' : (c.read ? 'bg-gray-50' : 'bg-white')}"
              ...
              <div class="w-12 h-12 ${avatarBg} rounded-2xl flex items-center justify-center text-gray-600 flex-shrink-0 overflow-hidden">${avatarInnerHTML(c,'w-6 h-6')}</div>
              <div class="flex-1 min-w-0">
          ...
          return `
            ...
            <div class="flex-1 overflow-y-auto p-5">
              <div class="flex flex-col items-center text-center mb-6">
                <div class="w-24 h-24 ${meta.avatarBg} rounded-full flex items-center justify-center text-gray-600 mb-3 overflow-hidden">${avatarInnerHTML(meta,'w-10 h-10')}</div>
        ...
        function conversationHTML(){
          ...
          return `
            <div class="px-5 pb-3 flex items-center gap-3 flex-shrink-0 border-b border-gray-100" style="padding-top:20px;">
              ...
              <div class="w-10 h-10 ${meta.avatarBg} rounded-2xl flex items-center justify-center text-gray-600 flex-shrink-0 overflow-hidden">${avatarInnerHTML(meta,'w-5 h-5')}</div>
              <div class="flex-1 min-w-0">
        ...
        function convoLogHTML(){
          ...
          return msgs.map(m => m.from === 'them' ? `
            <div class="flex items-start gap-3">
              <div class="w-8 h-8 ${meta.avatarBg} rounded-2xl flex items-center justify-center text-gray-600 flex-shrink-0 overflow-hidden">${avatarInnerHTML(meta,'w-4 h-4')}</div>
