const inboxFilters = [['general','General',0],['collaborations','Collaborations',0],['requests','Requests',3]];
        ...
        function requestRow(c){
          ...
          return `
            <div class="flex items-center gap-3.5 px-5 py-4 bg-white">
              ...
              <div class="flex items-center gap-2 flex-shrink-0">
                <button onclick="event.stopPropagation(); rejectRequest('${id}')" aria-label="Ignore" class="w-9 h-9 rounded-full flex items-center justify-center flex-shrink-0" style="border:1.5px solid #d1d5db;color:#6b7280;background:#fff;">${IconBold('close','w-4 h-4')}</button>
                <button onclick="event.stopPropagation(); acceptRequest('${id}')" aria-label="Accept" class="w-9 h-9 rounded-full flex items-center justify-center flex-shrink-0" style="border:1.5px solid ${ROYAL};color:${ROYAL};background:#fff;">${IconBold('check','w-4 h-4')}</button>
              </div>
            </div>`;
        }
        ...
        function sentRequestRow(c){
          ...
          return `
            <div class="flex items-center gap-3.5 px-5 py-4 bg-white">
              ...
              <button onclick="event.stopPropagation(); confirmWithdrawSentRequest('${id}','${escapeForJsAttr(name)}')" class="text-xs font-semibold px-4 py-1.5 rounded-full flex-shrink-0" style="border:1.5px solid #d1d5db;color:#6b7280;background:#fff;">Pending</button>
            </div>`;
        }
