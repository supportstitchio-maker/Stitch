        ...
        function newCollabNameHTML(){
          ...
          return `
            ...
            <div class="flex-1 overflow-y-auto px-5 py-5">
              <input id="new-collab-name-input" type="text" placeholder="Collaboration name" value="${newCollabName.replace(/"/g,'&quot;')}" class="w-full border-b-2 border-[${ROYAL}] py-2 text-[15px] mb-4" style="outline:none;">
