const jobsTabs = [['all','All'],['opportunities','Opportunities'],['internships','Internships'],['courses','Courses'],['scholarships','Scholarships'],['others','Others']];
        ...
        async function loadCurrentUserRole(){
          ...
          try {
            ...
            const { data: profile, error } = await sb
              .from(PROFILES_TABLE)
              .select('role, poster_status, poster_intent, poster_role, poster_business_name, poster_business_info, poster_business_established, poster_business_category, poster_business_website, poster_business_document_url, poster_id_document_url, poster_photo_url')
              .eq('user_id', user.id)
              .maybeSingle();
            if (!error && profile) {
        ...
        const POSTER_APP_STAGES = ['role', 'bizname', 'bizestablished', 'bizcategory', 'bizwebsite', 'bizdesc', 'bizdoc', 'photo', 'iddoc'];
        ...
        function posterAppStageSub(stage){
          ...
          return 'Submit an ID (any government-issued ID)';
        }
