          ...
          return `
            ...
            <div class="flex-1 overflow-y-auto px-5 pb-6">
              ...
              <div class="rounded-3xl p-4 mb-4 border" style="border-color:rgba(65,105,225,0.25);background:rgba(65,105,225,0.06);">
                ...
                <button onclick="openOverlayFrom('careerMatches','subscriptionSettings')" class="text-xs font-semibold py-2 px-4 rounded-full text-white" style="background:linear-gradient(135deg, ${NAVY} 0%, ${ROYAL} 100%);box-shadow:0 4px 14px rgba(65,105,225,0.35);">See plans</button>
              </div>` : ''}
