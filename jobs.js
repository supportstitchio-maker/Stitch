const jobsTabs = [['all','All'],['opportunities','Opportunities'],['internships','Internships'],['courses','Courses'],['scholarships','Scholarships'],['others','Others']];
        ...
        function adminDashboardTabPillsHTML(){
          const tabs = [['applications', `Poster applications${adminPosterApplications.length ? ` (${adminPosterApplications.length})` : ''}`], ['reports', `Reports${adminOpenReports.length ? ` (${adminOpenReports.length})` : ''}`]];
          return `
