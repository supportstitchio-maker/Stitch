            ...
            <div id="poster-app-form">
              <div class="mb-5">
                ...
                <div class="flex flex-col gap-2">
                  ${[['post','Post jobs & opportunities'],['explore','Explore & apply']].map(([key, label]) => `
                    <button onclick="setPosterAppIntent('${key}')" class="w-full flex items-center gap-3 px-4 py-3 rounded-2xl text-sm font-semibold text-left ${d.intent===key ? '' : 'bg-gray-100 text-gray-500 border border-gray-300'}" style="${d.intent===key ? `background:rgba(10,37,64,0.08);color:${NAVY};border:1.5px solid ${NAVY};` : ''}">
