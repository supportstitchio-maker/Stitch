        ...
        let careerStartDraft = { interests: [], jobTitle: '', experienceLevel: '', education: '', workStyle: '', fullName: '', email: '', phone: '', resumeFileName: '', resumeFile: null };
        ...
        function resetCareerStartDraft(){
          ...
          careerStartDraft = { interests: [], jobTitle: '', experienceLevel: '', education: '', workStyle: '', fullName: '', email: '', phone: '', resumeFileName: '', resumeFile: null };
        ...
        function careerStartStepBodyHTML(){
          ...
          if (stepId === 'interests') {
            return `
              <h2 class="text-2xl font-bold font-display text-gray-800 mb-5">What are you looking for?</h2>
              <div class="flex flex-col gap-2.5 mb-1">
          ...
          if (stepId === 'keyword') {
            return `
              <h2 class="text-2xl font-bold font-display text-gray-800 mb-5">What role, subject, or keyword are you searching for?</h2>
              ${careerStartFieldHTML('Keyword', 'jobTitle', 'text', 'e.g. Project Manager, Nursing, Climate advocacy')}`;
          }
          if (stepId === 'experience') {
            return `
              <h2 class="text-2xl font-bold font-display text-gray-800 mb-5">Which experience level fits you best?</h2>
              ${careerStartOptionListHTML(careerExperienceLevels, d.experienceLevel, 'setCareerStartExperience', 'experienceLevel', true)}`;
          }
          if (stepId === 'education') {
            return `
              <h2 class="text-2xl font-bold font-display text-gray-800 mb-5">What's your highest level of education?</h2>
              ${careerStartOptionListHTML(careerEducationLevels, d.education, 'setCareerStartEducation', 'education', false)}`;
          }
          if (stepId === 'workStyle') {
            return `
              <h2 class="text-2xl font-bold font-display text-gray-800 mb-5">How would you like to work or study?</h2>
          ...
          if (stepId === 'contact') {
            return `
              <h2 class="text-2xl font-bold font-display text-gray-800 mb-5">How can we reach you?</h2>
          ...
          if (stepId === 'resume') {
            return `
              <h2 class="text-2xl font-bold font-display text-gray-800 mb-3">Get 3x more matches with your resume</h2>
        ...
        function careerStartFormHTML(){
          ...
          const isLastStep = careerStartStepIds[careerStartStepIndex] === 'resume';
          ...
          return `
            <div class="flex-shrink-0 w-full" style="padding-top:20px;">
              <div class="max-w-2xl mx-auto px-5 pb-3 flex items-center gap-3">
                ...
                <div class="font-semibold text-base font-display grad-text flex-1">Don't Know Where to Start?</div>
            ...
            <div class="flex-1 overflow-y-auto px-5 pt-5">
              ...
              <button id="career-start-submit-btn" onclick="careerStartNext()" class="w-full font-semibold text-sm py-3 rounded-2xl text-white mt-6" style="background:${NAVY};margin-bottom:16px;">${isLastStep ? 'Submit' : 'Continue'}</button>
            </div>`;
        }
