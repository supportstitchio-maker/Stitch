        ...
        //     );
        const ADMIN_EMAILS = ['0stitchnkrumah@gmail.com']; // e.g. ['you@example.com'] -- quick local testing only
        ...
        function finalizeJobApplication(id){
          ...
          if (job.email) {
            ...
            window.location.href = `mailto:${job.email}?subject=${encodeURIComponent('Application: ' + job.title)}&body=${encodeURIComponent(bodyLines)}`;
          }
          const jobsContentEl = document.getElementById('jobs-content');
          if (jobsContentEl) jobsContentEl.innerHTML = jobsContent();
        }
