const jobsTabs = [['all','All'],['opportunities','Opportunities'],['internships','Internships'],['courses','Courses'],['scholarships','Scholarships'],['others','Others']];
        ...
        function careerStartFormHTML(){
          ...
          return `
            ...
            <div class="flex-1 overflow-y-auto px-5" style="padding-top:26px;padding-bottom:20px;">
              <div class="max-w-2xl mx-auto">
                <div class="text-xs font-bold uppercase tracking-wide text-gray-400 mb-5">Step ${stepNum} of ${total}</div>
                <div class="flex flex-col justify-between" style="min-height:100%;">
                  <div id="career-start-step-body">
                  ...
                  <div class="flex-shrink-0 mt-8">
                    <div class="flex items-center justify-between gap-3" style="margin-bottom:16px;">
                      ...
                      <button id="career-start-submit-btn" onclick="${resumeBusy ? '' : 'careerStartNext()'}" ${resumeBusy ? 'disabled' : ''} class="flex items-center gap-1.5 text-sm font-semibold px-4 py-2.5 rounded-full flex-1 justify-center text-white" style="background:linear-gradient(135deg, ${NAVY} 0%, ${ROYAL} 100%);box-shadow:0 4px 14px rgba(65,105,225,0.35);${resumeBusy ? 'opacity:.6;cursor:default;' : ''}">${nextBtnLabel}${!resumeBusy && !isLastStep ? Icon('arrowRight','w-4 h-4') : ''}</button>
                    </div>
                  </div>
                </div>
              </div>
