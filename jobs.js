        ...
        function jobCard(job){
          ...
          return `
            <div onclick="${job.isCatalogCourse ? `openCourseDetail('${job.id}')` : `openJobOrClassroom('${job.id}')`}" class="rounded-3xl p-4 text-white relative overflow-hidden mb-4 shadow-sm cursor-pointer" style="${blueCardBackgroundStyle(job, idx === -1 ? 0 : idx)}min-height:96px;">
