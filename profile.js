        ...
        function profileGridItem(post){
          ...
          return `<div class="relative w-full aspect-square overflow-hidden" style="border-radius:0;">${inner}</div>`;
        }
        ...
        // to view; falls back to your own profileData.photo when omitted so
        // existing Edit Profile callers keep working unchanged.
        function viewProfilePhoto(url){
        ...
        function saveEditProfile(){
          ...
          if (newUsername && USERNAME_INVALID_RE.test(newUsername)){
