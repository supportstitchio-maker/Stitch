        ...
        function autoSaveEditProfileDraft(){
          ...
          // Don't silently save a taken or reserved username on the way
          // out either; just keep whatever username was already valid.
          if (usernameEl && !isReservedStitchIdentity(usernameEl.value.trim()) && !isUsernameTaken(usernameEl.value.trim())) {
