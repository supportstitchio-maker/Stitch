        ...
        function onEditUsernameInput(){
          ...
          editUsernameError = (el && isReservedStitchIdentity(el.value)) ? RESERVED_STITCH_IDENTITY_MESSAGE : '';
          updateEditFieldErrorUI(el, editUsernameError);
        }

        // Same live-reserved-word check as onEditUsernameInput above, plus
        // clears any stale "that name isn't available" (taken) error as
        // the person edits it, so the red border/message doesn't just sit
        // there stale once they've actually started fixing it.
        function onEditNameInput(){
          const el = document.getElementById('edit-name');
          editNameError = (el && isReservedStitchIdentity(el.value)) ? RESERVED_STITCH_NAME_MESSAGE : '';
