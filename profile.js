const PUBLIC_PROFILES_TABLE = 'public_profiles';
        ...
        async function saveEditProfile(){
          ...
          // A minimum visible duration is enforced below so the spinner still appears even when
          // there's nothing to await (no photo upload, unchanged username).
        ...
        function profileMenuHTML(){
          return `
            <div class="flex-1 overflow-y-auto">
              ${overlayHeader('Settings and activity', '20px', null, null, {center:true})}
              <div class="p-5">
