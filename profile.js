        ...
        function profileLinksEditHTML(){
          ...
          return `
            <div class="flex flex-wrap gap-2 mb-3">
              ...
              <button type="button" onclick="toggleAddProfileLinkRow()" class="inline-flex items-center gap-1.5 text-xs font-semibold pl-2.5 pr-3 py-1.5 rounded-full" style="background:rgba(65,105,225,0.1);color:${ROYAL};">${Icon('plus','w-3 h-3')}Add link</button>
            </div>
