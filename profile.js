          ...
          return `
            <div class="flex-1 overflow-y-auto">
              ...
              ${settingsSection('Subscription', `
                ${settingsRow('bolt','Subscription', currentPlanName() === 'free' ? 'Free plan' : `${(PLAN_PRICING[currentPlanName()] || {}).label || currentPlanName()} · Active`, "openOverlay('subscriptionSettings')")}
              `)}
