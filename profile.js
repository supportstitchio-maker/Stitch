        ...
        // authEnterApp in games.js) so a brand-new account -- including
        // one from "Continue with Google" that never opens Edit Profile --
        // still shows up once it has a name/username.
