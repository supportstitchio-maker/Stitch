        ...
        async function generateStudyMaterials(text, resourceName){
          ...
          const system = 'You generate study material for an education app from a single uploaded resource. ' +
            ...
            'Questions: write genuine exam-ready multiple-choice questions the way a real professor would set them ' +
            'for a test on this material -- each one should test real understanding, application, or reasoning ' +
            'about a concept (working through a scenario, applying a formula/principle, comparing two concepts, ' +
            'identifying cause and effect), not simply "which term matches this definition". Word every stem, and ' +
            'every option, the way it would actually appear on a exam or past-questions paper: precise, ' +
            'unambiguous, and free of filler like "According to the text...". Vary the question style across the ' +
            'set instead of reusing one template for every question, and make sure exactly one option is correct ' +
            'and the other three are plausible, term-appropriate distractors (not obviously wrong filler). ' +
