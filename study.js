        ...
        function studyContent(){
          ...
          if (studySub === 'exams') return `
            ...
            <div onclick="openFlashDeck('all')" class="rounded-2xl p-6 cursor-pointer" style="background-image:linear-gradient(135deg, rgba(30,144,255,0.07) 0%, rgba(65,105,225,0.07) 100%);background-color:#ffffff;margin-bottom:50px;">
              <div class="flex items-center gap-2 text-xs uppercase tracking-wide text-[${NAVY}] font-bold mb-2">
            ...
            ${(!isTrialActive() && practiceCompleted && flashcardsCompleted) ? `
              <div class="rounded-2xl p-5 text-center" style="background-image:linear-gradient(135deg, rgba(30,144,255,0.09) 0%, rgba(65,105,225,0.09) 100%);background-color:#ffffff;margin-bottom:50px;">
        ...
        function subscriptionUpgradeHTML(){
          return `
            ...
            <div class="text-xs text-gray-400 leading-relaxed mt-2">Stitch Pro raises your total question/flashcard/Challenge Arena pool to 50 each (all uploads combined); Stitch Pro Plus raises it to 70 each. Both renew monthly and can be cancelled anytime from Profile. When a plan expires without renewing, your account automatically returns to the free pool (20 practice questions, 20 flashcards, 20 Challenge Arena questions) -- your uploads and existing progress are never deleted. Payments are processed securely by Paystack; we never see or store your card details.</div>
          `;
        }
