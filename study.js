        ...
        // Defensive reset for the Study FAB's own open/closed flag,
        // called whenever the Classroom screen is (re)entered so a stale
        // "open" state from a previous visit can never carry over and
        // render the menu as already-open without the user tapping
        // anything (see attachMenuScrollCloser in overlays.js for the
        // matching leaked-listener fix).
        function resetStudyFabMenu(){
