        ...
        const PLAN_DESCRIPTIONS = {
          free: '20 questions, flashcards & Challenge Arena a day. Limited Stitch Bot prompts.',
          pro: '50 questions & flashcards. Unlimited Stitch Bot prompts for a month.',
          proPlus: '70 questions & flashcards. Unlimited AI. CV filter & opportunity matching.',
          proMax: 'Unlimited questions & flashcards. Unlimited AI. CV filter, matching & opportunity recommendations.',
          platinum: 'Unlimited questions, flashcards & AI. CV filter, matching & recommendations — for a year.'
        };
        ...
        function subscriptionPlanCardHTML(planKey){
          ...
          return `
            <div class="rounded-2xl p-6 mb-4 relative overflow-hidden bg-white" style="box-shadow:0 10px 30px rgba(10,37,64,0.16), 0 3px 8px rgba(10,37,64,0.10);">
              ${badge ? `<img src="${badge}" alt="" class="absolute" style="right:-0.25rem;top:50%;transform:translateY(-50%);width:8.5rem;height:8.5rem;object-fit:contain;filter:drop-shadow(0 8px 12px rgba(10,37,64,0.28));pointer-events:none;user-select:none;-webkit-user-select:none;">` : ''}
        ...
        // badge + matching green text/pill) instead of only showing up
        // as the plain "Current Plan" header -- it isn't purchasable so
        // the pill is just a status pill, never a Subscribe action.
        function freePlanCardHTML(){
          const active = currentPlanName() === 'free';
          const [from] = planCardPalette.free;
          return `
            <div class="rounded-2xl p-6 mb-4 relative overflow-hidden bg-white" style="box-shadow:0 10px 30px rgba(10,37,64,0.16), 0 3px 8px rgba(10,37,64,0.10);">
              <img src="${planCardBadges.free}" alt="" class="absolute" style="right:-0.25rem;top:50%;transform:translateY(-50%);width:8.5rem;height:8.5rem;object-fit:contain;filter:drop-shadow(0 8px 12px rgba(10,37,64,0.28));pointer-events:none;user-select:none;-webkit-user-select:none;">
              <div class="relative" style="max-width:60%;">
        ...
        function subscriptionSettingsPlanRow(planKey){
          ...
          return `
            <div class="rounded-2xl p-5 mb-4 relative overflow-hidden bg-white" style="box-shadow:0 10px 30px rgba(10,37,64,0.16), 0 3px 8px rgba(10,37,64,0.10);">
              ${badge ? `<img src="${badge}" alt="" class="absolute" style="right:-0.25rem;top:50%;transform:translateY(-50%);width:7rem;height:7rem;object-fit:contain;filter:drop-shadow(0 8px 12px rgba(10,37,64,0.28));pointer-events:none;user-select:none;-webkit-user-select:none;">` : ''}
              <div class="relative" style="max-width:62%;">
                <div class="flex items-center gap-2 mb-1">
