        ...
        const planCardBadges = {
          pro: 'assets/subscription/pro.png',
          proPlus: 'assets/subscription/pro-plus.png',
          proMax: 'assets/subscription/pro-max.png',
          platinum: 'assets/subscription/platinum.png'
        };
        function subscriptionPlanCardHTML(planKey){
          ...
          return `
            <div class="rounded-2xl p-6 mb-4 relative overflow-hidden bg-white" style="box-shadow:0 10px 30px rgba(10,37,64,0.16), 0 3px 8px rgba(10,37,64,0.10);">
              ${badge ? `<img src="${badge}" alt="" class="absolute" style="right:0.5rem;top:50%;transform:translateY(-50%);width:6rem;height:6rem;object-fit:contain;filter:drop-shadow(0 8px 12px rgba(10,37,64,0.28));pointer-events:none;user-select:none;-webkit-user-select:none;">` : ''}
              <div class="relative" style="max-width:68%;">
                <div class="text-2xl font-bold mb-1" style="color:${NAVY};">${p.label}</div>
                ...
                <div class="text-sm text-gray-500 mb-5 leading-relaxed">${PLAN_DESCRIPTIONS[planKey] || ''}</div>
        ...
        function subscriptionSettingsPlanRow(planKey){
          ...
          return `
            <div class="rounded-2xl p-5 mb-4 relative overflow-hidden bg-white" style="box-shadow:0 10px 30px rgba(10,37,64,0.16), 0 3px 8px rgba(10,37,64,0.10);">
              ${badge ? `<img src="${badge}" alt="" class="absolute" style="right:0.5rem;top:50%;transform:translateY(-50%);width:5rem;height:5rem;object-fit:contain;filter:drop-shadow(0 8px 12px rgba(10,37,64,0.28));pointer-events:none;user-select:none;-webkit-user-select:none;">` : ''}
              <div class="relative" style="max-width:68%;">
                <div class="flex items-center gap-2 mb-1">
                ...
                <div class="text-sm text-gray-500 mb-3">${PLAN_DESCRIPTIONS[planKey] || ''}${credit > 0 ? ` · GHS ${credit} referral credit applied` : ''}</div>
