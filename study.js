        ...
        function studyFeatureCard(icon, eyebrow, title, sub, actionsHtml, onclick, extraStyle, image){
          return `
            <div ${onclick ? `onclick="${onclick}" class="bg-white rounded-3xl p-6 mb-4 relative overflow-hidden shadow-sm cursor-pointer"` : `class="bg-white rounded-3xl p-6 mb-4 relative overflow-hidden shadow-sm"`} style="${extraStyle || ''}">
              ${image ? `<img src="${image}" alt="" class="absolute -right-5 -top-5 w-32 h-32 pointer-events-none select-none" style="opacity:0.14;object-fit:contain;">` : ''}
              <div class="relative">
