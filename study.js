          ...
          document.getElementById('screen').innerHTML = `
            <div class="px-5 pb-5" style="padding-top:20px;">
              ...
              <div class="flex items-center justify-between mb-4">
                <button onclick="openLeaveClassModal()" class="flex items-center gap-1.5 flex-shrink-0">${gradIcon(IconBold('back','w-5 h-5'))}<span class="font-semibold text-sm grad-text">Leave Classroom</span></button>
