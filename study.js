let studyFabMenuOpen = false;
        ...
        // session -- same one-time-per-session idea as classroomNeedsLoadingAnimation for the
        ...
        // ---- Plan tiers + usage limits ---- No paid tiers, and no caps on practice questions,
        // flashcards, or Challenge Arena pool size either -- these are all unlimited for everyone
        ...
        // ---- Stitch Bot prompt usage/rate limiting (daily + weekly + monthly) ---- NOTE ON
        // SECURITY: these counters live in the same client-side "user state" blob as everything
        ...
        // Returns the number of prompts left, taking the *tightest* of the three windows -- e.g.
        // someone could have daily prompts left but have already hit their weekly or monthly cap.
