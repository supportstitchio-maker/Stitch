          ...
          return `
            <div class="rounded-2xl p-5 mb-3 border" style="border-color:rgba(65,105,225,0.25);background:rgba(65,105,225,0.06);">
              <div class="flex items-center justify-between mb-1">
                ...
                <div class="text-lg font-bold" style="color:${NAVY};">${p.currency} ${p.amount}<span class="text-xs font-semibold text-gray-400">/${p.cycle === 'Yearly' ? 'year' : 'month'}</span></div>
              </div>
              <div class="text-sm text-gray-500 mb-4">${PLAN_DESCRIPTIONS[planKey] || ''}</div>
