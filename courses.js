        ...
        function aiClassHTML(){
          ...
          return `
              ...
              <div class="w-full px-5 pb-3 relative" style="padding-top:20px;">
                <div class="flex items-center justify-between">
                  ...
                  <div class="flex items-center gap-1.5 flex-shrink-0">
                    <h1 class="text-base font-bold font-display grad-text truncate" style="max-width:32vw;">Stitch Bot</h1>
                  </div>
                </div>
            ...
            <div class="flex-shrink-0 px-3 pb-3 pt-2">
              ...
              <div class="flex flex-col gap-1.5 rounded-3xl px-3 pt-2.5 pb-2" style="background:#ffffff;border:1.5px solid rgba(10,37,64,0.10);box-shadow:0 8px 24px rgba(10,37,64,0.10);">
                <textarea id="ai-chat-input" rows="1" placeholder="Ask Stitch Bot anything..." onkeydown="handleAIChatInputKeydown(event)" oninput="autoGrowAIChatInput(this)" class="w-full bg-transparent text-sm resize-none leading-snug" style="max-height:120px; overflow-y:auto;"></textarea>
                <div class="flex items-center justify-between">
        ...
        function aiChatEmptyStateHTML(){
          ...
          return `
            <div class="h-full min-h-full flex flex-col items-center justify-center text-center gap-3 px-8">
              ...
              <div class="text-2xl font-bold font-display grad-text leading-snug">${first ? `What are we studying today, ${escapeHtml(first)}?` : 'What are we studying today?'}</div>
            </div>`;
        }
