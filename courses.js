        ...
        function classSettingsHTML(){
          ...
          return `
            ...
            <div class="flex-1 overflow-y-auto px-5 pb-8">
              ...
              ${cls.role === 'teacher'
                ? `<button onclick="openLeaveClassModal(leaveCurrentClass, 'Delete ' + cls.name + '?', 'This permanently deletes the class for you and every student in it, along with its stream, classwork, and materials. This can\\'t be undone.', 'trash')" class="w-full flex items-center justify-center gap-2 rounded-2xl py-3 font-semibold text-sm text-red-500 border border-red-100 bg-red-50">
