          ...
          return `
            <div class="flex-1 flex flex-col overflow-hidden">
              ...
              <div class="flex-1 overflow-y-auto no-scrollbar px-5 pb-8">
                ...
                ${item.type === 'document' ? `
                  <a href="${item.mediaUrl ? escapeHtml(item.mediaUrl) : '#'}" target="_blank" rel="noopener" class="bg-white rounded-3xl p-5 shadow-sm mb-3 border border-gray-100 flex items-center gap-3 ${item.mediaUrl ? '' : 'pointer-events-none opacity-60'}">
