          ...
          return `
            <div class="flex-1 flex flex-col overflow-hidden">
              ...
              <div class="flex-1 overflow-y-auto no-scrollbar px-5 pb-8">
                ...
                ${courseDetailTab === 'resources' ? courseResourcesTabHTML(c, enrolled) : courseDetailTab === 'announcements' ? courseAnnouncementsTabHTML(c) : `
            ...
            <div class="bg-white rounded-3xl p-4 shadow-sm mb-3 border border-gray-100">
              ...
              ${newCourseAddingItemModuleIndex === mi ? addCourseItemFormHTML() : `
                <button onclick="openAddCourseItemForm(${mi})" class="w-full flex items-center justify-center gap-2 rounded-xl py-2 font-semibold text-xs border border-dashed border-gray-300 text-gray-500">
                  ${Icon('plus','w-3.5 h-3.5')} Add Part <span class="normal-case font-medium text-gray-400">(video, picture, reading, or quiz)</span>
                </button>`}
            </div>`;
        }
          ...
          return `
            <div class="bg-blue-50 rounded-2xl p-3 mb-2">
              <div class="flex items-center gap-1.5 mb-2">
                <span class="text-[8px] font-bold uppercase tracking-wide px-1.5 py-0.5 rounded-full bg-white text-gray-500">This is a Part, inside the Module above</span>
              </div>
              ...
              <div class="flex gap-2">
                ...
                <button onclick="confirmAddCourseItem()" class="flex-1 rounded-xl py-2 font-semibold text-xs text-white" style="background:${NAVY};">${d.mediaUploading ? 'Uploading...' : 'Add'}</button>
              </div>
            </div>`;
        }
        ...
        function classTeacherDisplayName(cls){
          return (cls && cls.role === 'teacher') ? 'Stitch Nkrumah' : 'Stitch Team';
        }
          ...
          return `
            <div class="flex-1 flex flex-col overflow-hidden">
              ...
              <div class="flex-1 overflow-y-auto no-scrollbar px-5 pb-8">
                ...
                <button onclick="openLeaveClassModal(cancelCourseEnrollment, 'Cancel enrollment in ' + cls.name + '?', 'You\\'ll lose access to this course\\'s materials until you enroll again.')" class="w-full flex items-center justify-center gap-2 rounded-2xl py-2.5 mb-4 font-semibold text-xs text-red-500 border border-red-100 bg-red-50">
          ...
          return `
            ...
            <div class="flex flex-col gap-2.5 mb-5">
              <button onclick="openNewAnnouncementOverlay()" class="w-full flex items-center gap-3 bg-white rounded-2xl px-4 py-3.5 shadow-sm text-left">
                <span class="w-9 h-9 rounded-full bg-blue-50 flex items-center justify-center text-[${NAVY}] flex-shrink-0">${Icon('comment','w-4 h-4')}</span>
              ...
              <button onclick="openClassworkCreateMenu()" class="w-full flex items-center gap-3 bg-white rounded-2xl px-4 py-3.5 shadow-sm text-left">
                <span class="w-9 h-9 rounded-full bg-amber-100 flex items-center justify-center text-amber-600 flex-shrink-0">${Icon('doc','w-4 h-4')}</span>
              ...
              <button onclick="openInviteStudentsOverlay()" class="w-full flex items-center gap-3 bg-white rounded-2xl px-4 py-3.5 shadow-sm text-left">
                <span class="w-9 h-9 rounded-full bg-emerald-100 flex items-center justify-center text-emerald-600 flex-shrink-0">${Icon('personPlus','w-4 h-4')}</span>
              ...
              <button onclick="copyClassCode('${cls.code}')" class="w-full flex items-center gap-3 bg-white rounded-2xl px-4 py-3.5 shadow-sm text-left">
                <span class="w-9 h-9 rounded-full bg-purple-100 flex items-center justify-center text-purple-600 flex-shrink-0">${Icon('copy','w-4 h-4')}</span>
