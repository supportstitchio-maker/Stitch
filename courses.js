        ...
        // audio) -- which tab of the course detail screen is showing.
          ...
          return `
            <div class="flex-1 flex flex-col overflow-hidden">
              ...
              <div class="flex-1 overflow-y-auto no-scrollbar px-5 pb-8">
                ...
                ${courseDetailTab === 'resources' ? courseResourcesTabHTML(c, enrolled) : `
          ...
          return `
            <div class="flex-1 flex flex-col overflow-hidden">
              ...
              <div class="flex-1 overflow-y-auto no-scrollbar px-5 pb-8">
                ...
                ${item.type === 'video' ? `
                  <div class="bg-black rounded-3xl mb-3 flex items-center justify-center" style="aspect-ratio:16/9;">
                ...
                ${(item.type === 'video' || item.type === 'audio') && item.description ? `
        ...
        function addCourseItemFormHTML(){
          ...
          return `
            <div class="bg-blue-50 rounded-2xl p-3 mb-2">
              ...
              ${!isQuiz ? `
                <textarea oninput="updateAddingItemField('description', this.value)" placeholder="${(d.type === 'video' || d.type === 'audio') ? 'Notes (optional)' : 'Content / instructions'}" rows="2" class="w-full bg-white rounded-xl px-3 py-2 text-sm outline-none resize-none mb-2">${escapeHtml(d.description)}</textarea>` : `
                <div class="mb-2">
