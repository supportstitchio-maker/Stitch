        ...
        function archiveCurrentAIChat(){
          ...
          if (hasUserMessage) {
            aiChatSessions.unshift({ id: ++aiChatSessionIdCounter, messages: aiChatMessages.slice() });
          }
          aiChatMessages = [];
        }
        ...
        function toggleAIVoiceInput(){
          ...
          startMicRecording({ micBtnId: 'ai-mic-btn', inputId: 'ai-chat-input', defaultPlaceholder: 'Ask Stitch Bot anything...' });
        ...
        async function getAIResponse(text, attachments){
          ...
          try {
            ...
            const system = 'You are Stitch Bot, a warm, encouraging AI tutor and study buddy inside a study app for students across any subject. ' +
              'Talk like a genuinely helpful, upbeat friend who is great at the subject, not like a formal textbook: use natural, conversational language, contractions, and a bit of personality and warmth. It is fine to show enthusiasm about a cool concept or encourage the student when something is tricky. ' +
