          ...
          return `
            <div id="ai-msg-${id}" class="flex items-start">
              <div class="min-w-0" style="max-width:85%;">
                ...
                ${promptLimit ? `
                <button onclick="openSubscriptionUpgradeModal('stitchBot')" class="mt-2 w-full font-semibold py-2.5 rounded-2xl text-center text-[13.5px] text-white flex items-center justify-center gap-1.5" style="background:${NAVY};">${Icon('crown','w-4 h-4')} Upgrade plan</button>` : ''}
              </div>
            </div>`;
        }
