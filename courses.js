              ...
              <div class="w-full px-5 pb-3 relative" style="padding-top:20px;">
                <div class="flex items-center justify-between">
                  ...
                  <div class="flex items-center gap-1 flex-shrink-0">
                    <button onclick="openAIChatHistory()" title="Chat history" class="w-8 h-8 flex items-center justify-center">${gradIcon(Icon('comment','w-5 h-5'))}</button>
        ...
        async function getAIResponse(text, attachments){
          ...
          try {
            ...
            const system = 'You are Stitch Bot, a friendly, encouraging AI tutor inside a study app for students across any subject. ' +
