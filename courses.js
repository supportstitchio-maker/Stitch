            ...
            <div class="flex-shrink-0">
              <div class="w-full px-5 pb-3 relative" style="padding-top:20px;">
                <div class="flex items-center justify-between">
                  <div class="flex items-center flex-shrink-0" style="gap:0.125rem;">
                  ...
                  <div class="flex items-center gap-1.5 flex-shrink-0">
                    <h1 class="text-xl font-bold font-display grad-text truncate" style="max-width:32vw;">Stitch Bot</h1>
                  </div>
                </div>
        ...
        function aiChatEmptyStateHTML(){
          ...
          return `
            <div class="h-full min-h-full flex flex-col items-center justify-center text-center gap-3 px-8">
              ...
              <div class="text-2xl font-bold grad-text leading-snug" style="font-family:'Montserrat',sans-serif;">${first ? `What are we studying today, ${escapeHtml(first)}?` : 'What are we studying today?'}</div>
            </div>`;
        }
