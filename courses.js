              ...
              <div class="flex-1 overflow-y-auto no-scrollbar px-5 pb-8">
                ...
                ${item.type === 'video' ? `
                  <div class="bg-black rounded-3xl mb-3 overflow-hidden flex items-center justify-center" style="aspect-ratio:16/9;">
                    ${item.mediaUrl
                      ? `<video src="${item.mediaUrl}" class="w-full h-full object-cover" controls controlsList="nodownload" playsinline></video>`
                ...
                ${item.type === 'document' ? `
                  <div class="bg-white rounded-3xl p-5 shadow-sm mb-3 border border-gray-100 flex items-center gap-3">
                    ...
                    <div class="flex-1 min-w-0">
                      ...
                      <div class="text-xs text-gray-400">${item.mediaUrl ? 'File attached' : 'No file uploaded yet'}</div>
                    </div>
                  </div>` : ''}
                ${item.type === 'audio' ? `
                ...
                ${d.mediaUrl ? (d.mediaType === 'document' ? `
                  ...
                  <div class="relative rounded-xl overflow-hidden mb-2 bg-black" style="aspect-ratio:16/9;">
                    ${d.mediaType === 'image'
                      ...
                      : `<video src="${d.mediaUrl}" class="w-full h-full object-cover" controls controlsList="nodownload" playsinline></video>`}
