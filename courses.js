        ...
        function resetNewCourseDraft(){
          newCourseDraft = { title:'', org:'', description:'', modules:[] };
        }
        ...
        function courseCardHTML(c){
          ...
          return `
            <div onclick="openCourseDetail('${c.id}')" class="bg-white rounded-3xl p-5 mb-3 shadow-sm cursor-pointer">
              ...
              <div class="text-xs text-gray-400">${c.modules.length} module${c.modules.length === 1 ? '' : 's'} · ${courseTotalItems(c)} lesson${courseTotalItems(c) === 1 ? '' : 's'}</div>
            </div>`;
        }
          ...
          return `
            <div class="flex-1 flex flex-col overflow-hidden">
              ...
              <div class="flex-1 overflow-y-auto no-scrollbar px-5 pb-8">
                ...
                <div class="text-xs font-bold uppercase tracking-wide text-gray-400 mb-1">${escapeHtml(c.org)}</div>
        ...
        function publishNewCourse(){
          ...
          if (!d.title.trim() || !d.org.trim()) { alert('Please add a course title and organization.'); return; }
        ...
        function newCourseHTML(){
          const d = newCourseDraft;
          return `
            ${overlayHeader('Create a Course', '20px')}
            <div class="flex-1 overflow-y-auto px-5 pb-8">
              ...
              <div class="mb-4">
                <label class="text-xs font-bold uppercase tracking-wide text-gray-400 mb-1 block">Organization</label>
                <input type="text" value="${escapeHtml(d.org)}" oninput="updateNewCourseField('org', this.value)" placeholder="e.g. IBM" class="w-full bg-gray-100 rounded-2xl px-4 py-3 text-sm outline-none">
              </div>
              <div class="mb-5">
