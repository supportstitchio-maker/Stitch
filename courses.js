        ...
        function lectureReactionsSheetHTML(){
          ...
          return `
            <div class="absolute z-30 flex items-center gap-2 rounded-full py-2 px-3 shadow-lg bg-white overflow-x-auto" style="bottom:78px;left:10px;right:10px;width:fit-content;max-width:calc(100% - 20px);margin:0 auto;">
              ${reactionIcons.map(r => `
        ...
        function lectureCommentSheetHTML(){
          return `
            <div class="absolute z-30 flex items-center gap-2 rounded-full py-1.5 pl-4 pr-1.5 shadow-lg bg-white" style="bottom:78px;left:10px;right:10px;max-width:380px;margin:0 auto;">
